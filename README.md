...
- type in: npm install 
- type in: npm run dev
Then, the Terminal should state a local web address like http://localhost:5173. You can click that link or paste it into a web browser to play the tic-tac-toe game!
